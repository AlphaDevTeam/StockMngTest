...
describe('Service Tests', () => {
  describe('GoodsReceipt Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a GoodsReceipt', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            grnDate: currentDate.format(DATE_FORMAT)
      ...
      it('should update a GoodsReceipt', async () => {
        const returnedFromService = Object.assign(
          {
            grnNumber: 'BBBBBB',
            grnDate: currentDate.format(DATE_FORMAT),
      ...
      it('should return a list of GoodsReceipt', async () => {
        const returnedFromService = Object.assign(
          {
            grnNumber: 'BBBBBB',
            grnDate: currentDate.format(DATE_FORMAT),
      ...
      it('should delete a GoodsReceipt', async () => {
