...
describe('Service Tests', () => {
  describe('PurchaseOrderDetails Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a PurchaseOrderDetails', async () => {
        ...
        service
          .create(new PurchaseOrderDetails(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a PurchaseOrderDetails', async () => {
        const returnedFromService = Object.assign(
          {
            itemQty: 1
          },
      ...
      it('should return a list of PurchaseOrderDetails', async () => {
        const returnedFromService = Object.assign(
          {
            itemQty: 1
          },
      ...
      it('should delete a PurchaseOrderDetails', async () => {
