...
describe('Service Tests', () => {
  describe('ExUser Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new ExUser(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a ExUser', async () => {
      ...
      it('should update a ExUser', async () => {
        const returnedFromService = Object.assign(
          {
            userKey: 'BBBBBB'
          },
      ...
      it('should return a list of ExUser', async () => {
        const returnedFromService = Object.assign(
          {
            userKey: 'BBBBBB'
          },
      ...
      it('should delete a ExUser', async () => {
