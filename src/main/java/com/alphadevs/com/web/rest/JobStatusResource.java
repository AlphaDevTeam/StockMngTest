...
import com.alphadevs.com.service.JobStatusService;
import com.alphadevs.com.web.rest.errors.BadRequestAlertException;
import com.alphadevs.com.service.dto.JobStatusCriteria;
import com.alphadevs.com.service.JobStatusQueryService;
...
/**
 * REST controller for managing {@link com.alphadevs.com.domain.JobStatus}.
 */
@RestController
@RequestMapping("/api")
public class JobStatusResource {
    ...
    public ResponseEntity<List<JobStatus>> getAllJobStatuses(JobStatusCriteria criteria) {
        log.debug("REST request to get JobStatuses by criteria: {}", criteria);
        List<JobStatus> entityList = jobStatusQueryService.findByCriteria(criteria);
